...
const Analytics = () => {
  ...
  const categoryDistribution = technicians.reduce((acc, tech) => {
  ...
  const CategoryChart = () => (
    <div className="bg-white shadow rounded-lg p-6">
      <h3 className="text-lg font-medium text-gray-900 mb-4">Technicians by Category</h3>
          ...
          {topPerformers.map((tech, index) => (
            <div key={tech.id} className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-sm font-medium text-gray-900">{tech.rating} ⭐</p>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-600">New technician registrations</span>
