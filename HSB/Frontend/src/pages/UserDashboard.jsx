    ...
    try {
      ...
      if (res?.success) {
        const normalized = (res.data || []).map(j => ({
          ...
          assignedBusiness: j.assignedBusiness?.name,
                    ...
                    <div key={job.id} className="border border-gray-200 rounded-lg p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="font-medium">{job.responses} businesses interested</p>
                        </div>
                      </div>
                      
                      {job.assignedBusiness && (
                        <div className="mb-4">
                          <p className="text-sm text-gray-500">Assigned Business</p>
                          <p className="font-medium text-[#AF2638]">{job.assignedBusiness}</p>
                        </div>
                      )}
